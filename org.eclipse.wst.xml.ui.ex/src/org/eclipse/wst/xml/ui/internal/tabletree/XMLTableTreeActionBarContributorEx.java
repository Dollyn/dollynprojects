...
public class XMLTableTreeActionBarContributorEx implements IDesignViewerActionBarContributor{
	...
	public XMLTableTreeActionBarContributorEx() {
	}
...
*/
		if (editorPart instanceof XMLMultiPageEditorPartEx) {
			IWorkbenchPartSite site = editorPart.getSite();
			if (site instanceof IEditorSite) {
				ITextEditor textEditor = ((XMLMultiPageEditorPartEx) editorPart).getTextEditor();
	...
	protected XMLTableTreeViewerEx getTableTreeViewerForEditorPart(IEditorPart targetEditor) {
		XMLTableTreeViewerEx result = null;
		Object object = targetEditor.getAdapter(IDesignViewer.class);
		if (object instanceof XMLTableTreeViewerEx) {
			result = (XMLTableTreeViewerEx) object;
		}
		return result;
	}
