...
import flow.diagram.edit.policies.FlowTextSelectionEditPolicy;
 ...
 * @generated
 */
public class BeginNodeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BeginNodeNameEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return FlowElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new FlowParserProvider.HintAdapter(
					FlowElementTypes.BeginNode_1003, getParserElement(),
					parserHint);
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), FlowEditPartFactory
