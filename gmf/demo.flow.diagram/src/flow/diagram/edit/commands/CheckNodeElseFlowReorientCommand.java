 ...
 * @generated
 */
public class CheckNodeElseFlowReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CheckNodeElseFlowReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return FlowBaseItemSemanticEditPolicy.LinkConstraints
				.canExistCheckNodeElseFlow_4003(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return FlowBaseItemSemanticEditPolicy.LinkConstraints
				.canExistCheckNodeElseFlow_4003(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setElseFlow(null);
		getNewSource().setElseFlow(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setElseFlow(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
