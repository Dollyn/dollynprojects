 ...
 * @generated
 */
public class FlowLoadResourceAction implements IObjectActionDelegate {

	/**
	 * @generated
	 */
	private FlowEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
				...
				mySelectedElement = (FlowEditPart) structuredSelection
						.getFirstElement();
			}
		}
