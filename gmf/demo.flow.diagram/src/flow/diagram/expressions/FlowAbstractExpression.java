 ...
 * @generated
 */
public abstract class FlowAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = FlowDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected FlowAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
