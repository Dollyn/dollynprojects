...
/**
 * This is the item provider adapter for a {@link flow.Flow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FlowPackage.Literals.FLOW__END_NODE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FlowPackage.Literals.FLOW__NODES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FlowPackage.Literals.FLOW__NODES,
				 FlowFactory.eINSTANCE.createCheckNode()));

		newChildDescriptors.add
			(createChildParameter
				(FlowPackage.Literals.FLOW__NODES,
				 FlowFactory.eINSTANCE.createNormalNode()));

		newChildDescriptors.add
			(createChildParameter
				(FlowPackage.Literals.FLOW__NODES,
				 FlowFactory.eINSTANCE.createBeginNode()));
		...
		newChildDescriptors.add
			(createChildParameter
				(FlowPackage.Literals.FLOW__NODES,
				 FlowFactory.eINSTANCE.createExecuteNode()));

		newChildDescriptors.add
			(createChildParameter
				(FlowPackage.Literals.FLOW__NODES,
				 FlowFactory.eINSTANCE.createInfoFromUser()));

		newChildDescriptors.add
			(createChildParameter
				(FlowPackage.Literals.FLOW__NODES,
				 FlowFactory.eINSTANCE.createInfoToUser()));
	}
