...
/**
 * This is the item provider adapter for a {@link flow.NormalNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NormalNodeItemProvider
	 ...
	 * @generated
	 */
	public NormalNodeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NormalNode"));
	}
	...
	public String getText(Object object) {
		String label = ((NormalNode)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_NormalNode_type") :
			getString("_UI_NormalNode_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NormalNode.class)) {
